...
export const els = {
  ...
  emailAuthBtn: $<HTMLButtonElement>('email-auth-btn'), googleLoginBtn: $<HTMLButtonElement>('google-login-btn'),
  googleLoginBtnLabel: $('google-login-btn-label'),
  authSwitchBtn: $<HTMLButtonElement>('auth-switch-btn'), authSwitchCopy: $('auth-switch-copy'), backendWarning: $('backend-warning'),
  ...
  feedNotice: $('feed-notice'), feedNoticeText: $('feed-notice-text'), feedPagination: $('feed-pagination'),
